...
# disables this plugin (for instance, if this *.py file is really only a module for another file/plugin)
DISABLED = True
# even if there is only 1 dependency, it must be a 'list' type (enclosed in '[]').
DEPENDENCIES = ["example.py", "vault.py", "economy.py", "etc..."]
...
class Main:
    ...
    def _a_command(self, player, args):
        pass
