...
class Main:
            ...
            if bmname in self.data[player.username]:
                ...
                if cmd in ["bmgo", "bmdel"]:
                    player.message({"text": "Bookmark ", "color": "red", "extra": [
                        ...
                        {"text": " is not set.\n", "color": "red"},
                        {"text": " Use ", "color": "gray"},
                        {"text": "/bmset", "color": "gold", "clickEvent": {"action": "suggest_command",
                                                                           "value": "/bmset"}},
                        {"text": " <name>", "color": "gold", "italic": True}
                    ]})
                    return False
                        ...
                        player.message({"text": "Maximum number of bookmarks already in use.\n",
                                        "color": "red", "extra":
                                            [
                                                ...
                                                {"text": "/bmdel", "color": "gold", "clickEvent":
                                                    {"action": "suggest_command", "value": "/bmdel"}},
                                                {"text": " <name>", "color": "gold", "italic": True},
                                                {"text": " first.\n Use ", "color": "gray"},
                                                {"text": "/bmlist", "color": "gold",
                                                 "clickEvent": {"action": "run_command", "value": "/bmlist"}},
    ...
    def bookmarkset(self, player, args):
        ...
        player.message({"text": "Bookmark ", "color": "green", "extra": [
            ...
            {"text": " set.\n", "color": "green"},
            {"text": " Use ", "color": "gray"},
            {"text": "/bmgo %s" % bmname, "color": "gold", "clickEvent": {"action": "run_command",
                                                                          "value": "/bmgo %s" % bmname}},
