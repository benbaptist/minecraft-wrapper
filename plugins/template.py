...
VERSION = (1, 0) # the version number, with commas in place of periods. add more commas if needed.
...
By the way, this is an intentionally long string demonstrating what descriptions are for.
Descriptions will only be used in some parts of Wrapper.py, such as when you 
hover over a plugin name when you run /plugins, or in the future web interface. 
